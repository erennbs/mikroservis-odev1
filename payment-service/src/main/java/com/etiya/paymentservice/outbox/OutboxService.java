...
public class OutboxService {
     ...
     *
     * @param aggregateType domain aggregate, e.g. {@code "Payment"} (used by Debezium for routing)
     * @param aggregateId   aggregate instance id, e.g. the payment id (becomes the Kafka key)
     * @param type          logical event name, e.g. {@code "PaymentCreated"}
